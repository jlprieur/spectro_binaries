...
3001  FORMAT(/,'Résidus partiels pour poids=',F6.3,/,
     1       'Sigma O-C: Etoile primaire (1)   ',F5.2,' km s$^{-1}$',/,
     1       'Sigma O-C: Etoile secondaire (2) ',F5.2,' km s$^{-1}$')
C Deuxième iteration avec poids=1.0
        POI_0=1.0
        ENDDO
      ENDIF
C Calcul de l'ecart-type des residus (non pondérés)
...
3002  FORMAT(/,'Sigma O-C (non pondéré): Etoile primaire (1)   ',
     1       F5.2,' km s$^{-1}$',/,
     1         'Sigma O-C (non pondéré): Etoile secondaire (2) ',
     1       F5.2,' km s$^{-1}$',/,
     1       'Sigma O-C (non pondéré): global: ',F5.2,' km s$^{-1}$',/)
C Calcul de l'ecart-type des residus (pondérés)
...
3000  FORMAT(/,'Sigma O-C (pondéré): Etoile primaire (1)   ',
     1       F5.2,' km s$^{-1}$',/,
     1         'Sigma O-C (pondéré): Etoile secondaire (2) ',
     1       F5.2,' km s$^{-1}$',/,
     1       'Sigma O-C (pondéré): global: ',F5.2,' km s$^{-1}$',/)
      CLOSE(LU_OUT)
C Latex format:
...
C Calcul de la vitesse radiale (formule fondamentale, p81):
      ...
      END
C*************************************************************
C Calcul de l'ecart-type des residus (non pondéré) pour une composante
C*************************************************************
      ...
      END
C*************************************************************
C Calcul de l'ecart-type des residus (pondéré) pour une composante
C*************************************************************
...
C*************************************************************
      ...
      END
C*************************************************************
C Calcul de l'ecart-type global des residus (pondéré)
C*************************************************************
      ...
      END
C*************************************************************
C Calcul de l'ecart-type global des residus (non pondéré)
C*************************************************************
